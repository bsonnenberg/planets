...
for filename in os.listdir(directory):
	if filename.endswith(".txt"):
		match = re.search(r'practic_(\d{2}\-\dH)\_([\d\w]{10})\_(M)\_([\d\w]{10})\_(F).txt', filename)
		male = (match.group(2))
		#print(male)
			...
			for a in male_list:
				...
				if yep > 10:
					...
					while yep2 < 10:
						...
						print('MALE VISIT', yep2)
						m_count += 1
		except StopIteration:
			pass				
		print(match.group(1), 'total male visits', m_count)	
########################### FEMALE VISIT LOOP ###########################################			
			...
			for b in female_list:
				...
				if yeep > 15:
					...
					while yep2_f < 15:
						...
						print('FEMALE VISIT', yep2_f)
						f_count += 1
		except StopIteration:
			pass
		print(match.group(1), 'total female visits', f_count)
		#print(visit)			
